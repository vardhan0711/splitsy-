...
export default function ContactsPage() {
  ...
  // Safely destructure data with default empty arrays
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <Avatar className="h-10 w-10">
                            ...
                            <AvatarFallback>
                              {/* FIX: Add defensive check for user.name */}
                              {(user.name ? user.name.charAt(0) : 'U').toUpperCase()}
                            </AvatarFallback>
                          </Avatar>
                          <div>
                            {/* Also add defensive check for displaying name and email */}
                    ...
                    <CardContent className="py-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            {/* Defensive check for group name */}
