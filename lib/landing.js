...
export const TESTIMONIALS = [
  {
    quote:
      "Ye Babu Rao ka style hai! Splitsy ke saath, ab mujhe confusion nahi hota ki kaun kisko kitna dega!",
    name: "Babu Rao",
  ...
  {
    quote:
      "Splitsy ki calculations itni accurate hain, meri 25 din mein paisa double karne ki scheme se bhi behtar!",
    name: "Raju",
  ...
  {
    quote:
      "Agar mere paas Splitsy hota, toh Raju mere joote aur coat bechkar bhaag nahi pata! Uske debt mein aur add karta!",
    name: "Shyam",
